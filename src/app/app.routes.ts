...
export const routes: Routes = [
  ...
  { path: 'auth/update-password', loadComponent: () => import('./features/auth/update-password.component').then((m) => m.UpdatePasswordComponent) },
  {
    path: '',
    ...
    children: [
      ...
      { path: 'access-rejected', loadComponent: () => import('./features/auth/access-rejected.component').then((m) => m.AccessRejectedComponent) },
      { path: 'access-suspended', loadComponent: () => import('./features/auth/access-suspended.component').then((m) => m.AccessSuspendedComponent) },
      { path: 'invitations', loadComponent: () => import('./features/auth/invitations.component').then((m) => m.InvitationsComponent) },
      { path: 'onboarding/migrate', loadComponent: () => import('./features/auth/migration-wizard.component').then((m) => m.MigrationWizardComponent) },
      { path: 'onboarding/team', loadComponent: () => import('./features/auth/onboarding-team.component').then((m) => m.OnboardingTeamComponent) },
      { path: 'settings/team/members', loadComponent: () => import('./features/auth/members.component').then((m) => m.MembersComponent), canActivate: [ApprovedGuard] },
      { path: 'admin', loadComponent: () => import('./features/auth/admin-access.component').then((m) => m.AdminAccessComponent), canActivate: [AdminGuard] },
      { path: 'admin/access', redirectTo: 'admin' },
      { path: 'team', loadComponent: () => import('./features/roster/roster.component').then((m) => m.RosterComponent), canActivate: [ApprovedGuard] },
      {
        path: 'board/draft',
      ...
      { path: 'library', loadComponent: () => import('./features/library/library.component').then((m) => m.LibraryComponent), canActivate: [ApprovedGuard] },
      { path: 'sessions', loadComponent: () => import('./features/sessions/sessions.component').then((m) => m.SessionsComponent), canActivate: [ApprovedGuard] },
    ],
  },
